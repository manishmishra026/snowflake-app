...
locals {
  ...
  monitoring_rg_name = var.monitoring_resource_group_name != "" ? var.monitoring_resource_group_name : "rg-${local.name_prefix}-monitoring"
...
# Dedicated Logging & Monitoring Resource Group
